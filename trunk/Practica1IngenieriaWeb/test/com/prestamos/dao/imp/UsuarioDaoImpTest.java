...
public class UsuarioDaoImpTest {
    ...
    public void testInsertar() throws Exception {
        ...
        Usuario usuario = instance.buscar(new UsuarioId("cedula", "123"));
    ...
    public void testBuscar() throws DaoException {
        ...
        Usuario result = instance.buscar(new UsuarioId("cedula", "123"));
    ...
    public void testActualizar() throws DaoException {
        ...
        usuario= instance.buscar(new UsuarioId("cedula", "123"));
